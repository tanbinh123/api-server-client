    ...
    <a-table
      ...
      <template slot="action" slot-scope="record">
        <div class="row-operations">
          <a-tooltip v-permission="['sysMsgType:toggle']" :title=" record.state==='ON'?'启用':'禁用' ">
            <a-switch size="small" :checked="record.state === 'ON'" @change="toggleState(record)"/>
          </a-tooltip>
          <a-button
            v-permission="['sysMsgType:update']"
            class="rowBtn"
            size="small"
            type="link"
          ...
          <a-popconfirm
            v-permission="['sysMsgType:remove']"
            placement="top"
            title="确定删除此数据吗？"
            trigger="hover"
...
import TagsInput from '@/components/Service/TagsInput'
