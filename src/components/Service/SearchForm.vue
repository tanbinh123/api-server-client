      ...
      <a-row :gutter="20">
        ...
        <a-col v-for="(item,i) in searchFields" v-if="i< size" :key="i" :md="cmd" :sm="24">
          <a-form-item :label="item.name">
            ...
            >
              <a-select-option
                v-for="(sonItem,sonIx) in item.list"
                :key="sonIx"
                :value="sonItem.value ? sonItem.value : sonItem.label">{{ sonItem.label ? sonItem.label : sonItem.value }}
              </a-select-option>
            </a-select>
            <a-date-picker
            ...
            >
              <a-radio
                v-for="(sonItem,sonIx) in item.list"
                :key="sonIx"
                :value="sonItem.value ? sonItem.value : sonItem.label">
                {{ sonItem.label ? sonItem.label : sonItem.value }}
              </a-radio>
            </a-radio-group>
